// Homework: 14_occupancy_tuning.cu
// Complete based on classwork/14_occupancy_tuning.cu
//
// Instructions:
...
int main() {
    printf("Homework: 14_occupancy_tuning - Implement the exercises from classwork\n");
    return 0;
}
