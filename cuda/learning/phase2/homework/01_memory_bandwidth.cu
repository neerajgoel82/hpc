// Homework: 01_memory_bandwidth.cu
// Complete based on classwork/01_memory_bandwidth.cu
//
// Instructions:
...
int main() {
    printf("Homework: 01_memory_bandwidth - Implement the exercises from classwork\n");
    return 0;
}
