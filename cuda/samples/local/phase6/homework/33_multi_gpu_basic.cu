// Homework: 33_multi_gpu_basic.cu
// Complete based on classwork/33_multi_gpu_basic.cu
//
// Instructions:
...
int main() {
    printf("Homework: 33_multi_gpu_basic - Implement the exercises from classwork\n");
    return 0;
}
