"""
Homework: project_sales_analysis.py

Complete the exercises below based on the concepts from project_sales_analysis.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 project_sales_analysis.py
...
if __name__ == "__main__":
    print(f"Homework: project_sales_analysis")
