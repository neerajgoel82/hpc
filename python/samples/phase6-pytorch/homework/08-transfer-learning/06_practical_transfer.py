"""
Homework: 06_practical_transfer.py

Complete the exercises below based on the concepts from 06_practical_transfer.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 06_practical_transfer.py
...
if __name__ == "__main__":
    print(f"Homework: 06_practical_transfer")
