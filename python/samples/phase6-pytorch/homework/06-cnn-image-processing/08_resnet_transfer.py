"""
Homework: 08_resnet_transfer.py

Complete the exercises below based on the concepts from 08_resnet_transfer.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 08_resnet_transfer.py
...
if __name__ == "__main__":
    print(f"Homework: 08_resnet_transfer")
