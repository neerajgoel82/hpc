"""
Homework: project_simple_gan.py

Complete the exercises below based on the concepts from project_simple_gan.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 project_simple_gan.py
...
if __name__ == "__main__":
    print(f"Homework: project_simple_gan")
