"""
Homework: 08_regularization.py

Complete the exercises below based on the concepts from 08_regularization.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 08_regularization.py
...
if __name__ == "__main__":
    print(f"Homework: 08_regularization")
