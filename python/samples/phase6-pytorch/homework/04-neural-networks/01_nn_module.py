"""
Homework: 01_nn_module.py

Complete the exercises below based on the concepts from 01_nn_module.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 01_nn_module.py
