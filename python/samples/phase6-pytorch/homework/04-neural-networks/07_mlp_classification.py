"""
Homework: 07_mlp_classification.py

Complete the exercises below based on the concepts from 07_mlp_classification.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 07_mlp_classification.py
...
if __name__ == "__main__":
    print(f"Homework: 07_mlp_classification")
