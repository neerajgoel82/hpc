"""
Homework: 01_custom_architectures.py

Complete the exercises below based on the concepts from 01_custom_architectures.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 01_custom_architectures.py
...
if __name__ == "__main__":
    print(f"Homework: 01_custom_architectures")
