"""
Homework: 05_pytorch_lightning.py

Complete the exercises below based on the concepts from 05_pytorch_lightning.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 05_pytorch_lightning.py
...
if __name__ == "__main__":
    print(f"Homework: 05_pytorch_lightning")
