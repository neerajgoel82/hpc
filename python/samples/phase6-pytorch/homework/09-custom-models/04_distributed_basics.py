"""
Homework: 04_distributed_basics.py

Complete the exercises below based on the concepts from 04_distributed_basics.py
in the classwork folder.

Instructions:
1. Read the corresponding classwork file first
2. Implement the solutions below
3. Run: python3 04_distributed_basics.py
...
if __name__ == "__main__":
    print(f"Homework: 04_distributed_basics")
